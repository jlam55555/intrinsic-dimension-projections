...
plt.axhline(0.9677, color='k', linestyle='--', alpha=0.5)

plt.legend(['Local 784-200-200', 'Li et. al (2018) 784-200-200', 'Direct 784-200-200'])
...
# plt.show()
plt.savefig('plots/local_vs_li.pdf')
